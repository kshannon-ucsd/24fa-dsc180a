...
\copy (
    ...
    unique_p.gender
    FROM unique_p
    LEFT JOIN elixhauser_quan
    ON elixhauser_quan.hadm_id = unique_p.hadm_id
    WHERE
    ...
    TO '/workspaces/kmeans_clustering/data/patients_w_elixhauser_age_group.csv' CSV HEADER;